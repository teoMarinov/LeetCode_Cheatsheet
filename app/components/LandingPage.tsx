...
const LandingPage = () => {
  ...
  const text = `
  The function isMatch takes two parameters: s (the input string) and p (the pattern to match against).
  ...
  return (
    <div className="pt-60 flex flex-col gap-y-10 w-[98%]">
      ...
      <h3 className="text-4xl text-center font-semibold">
        ...
        to write down the solutions for all LeetCode problems you{"'"}ve solved!
      </h3>
